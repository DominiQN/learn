...
class SingleNumberIITest {
    ...
    @Test
    void ex1() {
        int result = singleNumberII.singleNumber(listOf(1, 2, 4, 3, 3, 2, 2, 3, 1, 1));
    ...
    @Test
    void ex2() {
        int result = singleNumberII.singleNumber(listOf(0, 0, 0, 1));
    ...
    @Test
    void ex4() {
        int result = singleNumberII.singleNumber(listOf(528));
